          ...
          <div className="flex justify-center items-center">
            ...
            <div className="relative group">
              <button className="flex flex-col items-center justify-center w-8 h-8 space-y-1">
                <span className="w-6 h-0.5 bg-gray-600 transition-all duration-300 group-hover:bg-black"></span>
                <span className="w-6 h-0.5 bg-gray-600 transition-all duration-300 group-hover:bg-black"></span>
                <span className="w-6 h-0.5 bg-gray-600 transition-all duration-300 group-hover:bg-black"></span>
              </button>
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg py-2 min-w-[150px] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 text-center">
                ...
                <a href="/portfolio" className="block px-4 py-2 text-sm text-gray-600 hover:text-black hover:bg-gray-50 transition-colors">
                  Portfolio
                </a>
                <a href="/preise" className="block px-4 py-2 text-sm text-gray-600 hover:text-black hover:bg-gray-50 transition-colors">
                  Preise
                </a>
                <a href="/roi-rechner" className="block px-4 py-2 text-sm text-gray-600 hover:text-black hover:bg-gray-50 transition-colors">
                  ROI-Rechner
                </a>
                <a href="/blog" className="block px-4 py-2 text-sm text-gray-600 hover:text-black hover:bg-gray-50 transition-colors">
                  Blog
                </a>
                <a href="/kontakt" className="block px-4 py-2 text-sm text-gray-600 hover:text-black hover:bg-gray-50 transition-colors">
                  Kontakt
                </a>
              </div>
            </div>
