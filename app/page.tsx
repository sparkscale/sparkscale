      ...
      <div className="fixed bottom-6 right-6 z-50 md:hidden">
        <Magnet padding={20} disabled={false} magnetStrength={6}>
          <a 
            ...
            className="bg-gray-700 hover:bg-gray-800 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110"
      ...
      <div className="fixed bottom-6 left-6 z-50 md:hidden">
        <Magnet padding={20} disabled={false} magnetStrength={6}>
          <a 
            ...
            className="bg-gray-800 hover:bg-gray-900 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110"
            aria-label="Anrufen"
          >
  ...
  pointerEvents: 'none'
      ...
      <section className="py-16 md:py-24 px-8 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto max-w-6xl">
          <ScrollAnimation animation="slideUp" delay={0.2}>
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-light mb-4 text-white">
                    Warum <span className="font-bold text-[#a29a88]">Spark&Scale</span>?
              </h2>
                  <p className="text-lg text-gray-300">SEO & Performance Expertise, die Ergebnisse liefert</p>
            </div>
          </ScrollAnimation>

          <ScrollAnimation animation="staggerUp" delay={0.2} stagger={0.15} triggerStart="top 98%">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">90% Seite 1 Rankings</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Unsere SEO-Expertise bringt 90% unserer Kunden auf die erste Google-Seite. 
                  Durchschnittlich +340% mehr organischer Traffic - messbare Ergebnisse oder Geld zurück.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">KI-Search Optimierung</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Optimierung für Googles KI-Suche und semantische Search. Strukturierte Daten, 
                  Entity-SEO, Featured Snippets. 85% mehr qualifizierte Anfragen durch KI-Search-Optimierung.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Zukunftsfähige Technologie</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Websites bereit für die nächste Generation der Suche. Core Web Vitals Optimierung, 
                  Lighthouse Score 95+, Voice Search Ready - Ihr Vorsprung für morgen.
                </p>
              </div>
            </div>
          </ScrollAnimation>
          ...
          <ScrollAnimation animation="scaleIn" delay={0.3} triggerStart="top 98%">
            <div className="text-center bg-gray-100 border border-gray-300 rounded-2xl p-6">
              ...
              <p className="text-black text-sm">
                Nur <span className="font-bold">5 neue SEO-Projekte pro Monat</span> für maximale Aufmerksamkeit und Ergebnisse. 
                Während Ihre Konkurrenz auf Seite 2 wartet, erobern Sie Seite 1.
              </p>
            </div>
          </ScrollAnimation>
        </div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <ScrollAnimation animation="fadeIn" delay={0.4}>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              ...
              wie wir Ihre Website zum Umsatzmotor machen.
            </p>
          </ScrollAnimation>

          {/* Multiple CTA Options */}
          <ScrollAnimation animation="slideUp" delay={0.3} triggerStart="top 98%">
              ...
              <Magnet padding={40} disabled={false} magnetStrength={8}>
                ...
                >
                  Pakete & Preise ansehen
                    ...
                    {/* Trust Badges */}
          <ScrollAnimation animation="staggerUp" delay={0.8} stagger={0.1} triggerStart="top 95%">
        ...
        <div className="container mx-auto max-w-6xl">
          <ScrollAnimation animation="slideUp" delay={0.2}>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-500">Echte Erfahrungen, echte Ergebnisse</p>
            </div>
          </ScrollAnimation>
          ...
          <ScrollAnimation animation="fadeIn" delay={0.4}>
            <InfiniteMovingCards
              items={[
                {
                  quote: "Von Seite 3 auf Platz 1 in nur 4 Monaten! Die SEO-Expertise von Spark&Scale hat unsere lokalen Anfragen verdreifacht. Unfassbar!",
                  name: "Dr. Sarah Weber",
                  title: "Zahnarztpraxis Weber"
                },
                {
                  quote: "Die Performance-Garantie war der Grund, warum wir uns entschieden haben. Beste Entscheidung! ROI hat sich in 6 Monaten amortisiert.",
                  name: "Lisa Chen",
                  title: "E-Commerce Lifestyle"
                },
                {
                  quote: "Professionell, transparent und ergebnisorientiert. Unsere Conversion Rate ist um 187% gestiegen. Absolute Empfehlung!",
                  name: "Thomas Müller",
      ...
      <section className="py-16 md:py-20 px-8 bg-gradient-to-br from-black via-gray-800 to-gray-900">
        <div className="container mx-auto max-w-4xl">
          ...
          <ScrollAnimation animation="staggerUp" delay={0.3} stagger={0.1} triggerStart="top 95%">
